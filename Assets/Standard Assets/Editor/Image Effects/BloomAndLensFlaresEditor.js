...
{	
    ...
    function OnInspectorGUI () {        
		...
		GUILayout.Label("HDR " + (hdr.boolValue ? "enabled, " : "disabled, ") + (useSrcAlphaAsMask.floatValue < 0.1f ? "currently ignoring alpha channel glow" : "currently using alpha channel glow"), EditorStyles.miniBoldLabel);
